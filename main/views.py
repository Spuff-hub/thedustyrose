...
class CatalogViews(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for filter_key, filter_func in self.FILTER_MAPPING.items():
            value = self.request.GET.get(filter_key)
            if value:
...
class ProductDetailView(DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return TemplateResponse(request, 'main/product_detail_full.html', context)